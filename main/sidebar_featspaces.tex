...
The signal achievement of machine learning in general and deep learning in particular has been its ability to weaponize computation
to obliterate the obstacles necessary for industrial progress. Control needs to provide insight into the structure of the spaces
