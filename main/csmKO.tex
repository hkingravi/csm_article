...
The work presented was supported in part by AFOSR \#FA9550-15-1-0146, and USDA/NSF grant CPS: Medium: Robust Deep Learning and Decision Making for Mechanical Weeding Agbots. We thank Adam Davis from UIUC Crop-Science, and Chinmay Soman from EarthSense in helping us understand the herbicide resistant weed problem and envisioning CPS and robotics solutions for it.
