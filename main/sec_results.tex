...
The $k$-means algorithm divides the system nicely through the middle, as expected.
...
\begin{figure*}[h]
	...
	\caption{Convergence results for CFD, showing ,ean, 15th, and 85th percentile path performance}
\end{figure*}
