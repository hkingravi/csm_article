...
\begin{figure}
	...
	\includegraphics[width=0.45\columnwidth]{pathfinder_raw_data_example}
	\label{fig:Rawpathfinder} }
	\subfloat[AKO estimate]{
	\includegraphics[width=0.45\columnwidth]{pathfinder_inference_example}
	\label{fig:pathfinder} }
	
	\subfloat[Error-day (time-series)]{
		\includegraphics[width=0.45\columnwidth]{time_series_day} \label{fig:time_series_day} }
	\subfloat[Error-night (time-series)]{
		\includegraphics[width=0.45\columnwidth]{time_series_night} \label{fig:time_series_night} }
	 %pathfinder_errors_boxplot_2012_all_models_night.pdf
	 
	\subfloat[Error-day (box-plot)]{
		\includegraphics[width=0.45\columnwidth]{box_plot_path_day} \label{fig:pathfinder_errors_boxplots_day} }
	\subfloat[Error-night (box-plot)]{
		\includegraphics[width=0.45\columnwidth]{box_plot_path} \label{fig:pathfinder_errors_boxplots} }
		
	\subfloat[Estimation time (day)]
	{
		\includegraphics[width=0.45\columnwidth]{box_plot_path_day_time} \label{fig:pathfinder_tr_times_boxplots_day}}
	\subfloat[Estimation time (night)]
	{
		\includegraphics[width=0.45\columnwidth]{box_plot_path_time} \label{fig:pathfinder_tr_times_boxplots_night}}
...
\begin{figure*}
	...
	\includegraphics[scale=0.24]{May6}
	\label{fig:May6 } }
	\hspace{-0.4in}
	\subfloat[7th May]{
	\includegraphics[scale=0.24]{May7}
	\label{fig:May7 } }
	\hspace{-0.4in}
	\subfloat[28th May]{
	\includegraphics[scale=0.24]{May28}
	\label{fig:May28 } }
	\hspace{-0.4in}\subfloat[29th May]{
	\includegraphics[scale=0.24]{May29}
	\label{fig:May29 } }
