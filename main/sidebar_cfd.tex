...
\begin{figure*}[h] %{r}{0.5\textwidth}
	...
	\subfloat[\small{Different Models Tested on Re=800}]{
		\includegraphics[width=0.7\textwidth]{boxploterrors800}
