...
{\color{red}(Response)} Hassan/Girish \gXX{Hassan can you please respond}
...
{\color{red}(Response)} We have condensed this paper by 10\% from the previous version.
...
{\color{red}(Response)} The authors thank the anonymous reviewer for thier helpful comments. 
...
{\color{red}(Response)} \gXX{Hassan can you please respond}
...
{\color{red}(Response)} \gXX{Harshal can you please respond}
...
{\color{red}(Response)} 
ending commas and periods fixed. References not fixed \gXX{Harshal can you please respond}. \gXX{Theorem 4 has not been restructured}.
