...
\rr{A more clever approach is to use state-space representations of time-varying GPs \cite{simo}. In this view point, each GP instance is viewed as a snapshot of an evolving set of weights. We follow in a similar vein here, with added emphasis on understanding the mathematical structures leading to observability and controllability.}
