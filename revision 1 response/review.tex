...
{\color{red}(Response)} We have included an extensive discussion of this method in view of Koopman operator theory. We have also included a comparison of the modes discovered by this method to those obtained via dynamic mode decomposition. RESPONSE???
...
---------------
\begin{enumerate}
\item page 1 line 10, "spatiotemporally" misspelled \gXX{Josh}
\item page 4 line 24 "interpretability" misspelled \gXX{Josh}
