...
\begin{subfigure}[t]{0.32\textwidth}
	\includegraphics[width=\linewidth]{"Figure 5a"}
	\caption{Gaussian}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
	\includegraphics[width=\linewidth]{"Figure 5b"}
	\caption{Laplacian}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
	\includegraphics[width=\linewidth]{"Figure 5c"}
	\caption{Periodic}
\end{subfigure}
 ...
 \begin{tikzpicture}[->,>=stealth',auto,node distance=1cm,
  ...
  \node[inner sep=0pt,label=below:{\tiny Functional inference 
    ...
    {\includegraphics[trim=2.4cm 2.6cm 3.4cm 1.5cm,clip,
                      width=0.18\textwidth,
                      height=0.08\textwidth]{"Figure 7c"}};    
...
\begin{subfigure}[t]{0.48\textwidth}
	\includegraphics[width=\linewidth]{"Figure 9a"}
	\caption{Shaded vs. observability}
    	\label{fig:kobs_small}
\end{subfigure}

\begin{subfigure}[t]{0.48\textwidth}
	\includegraphics[width=\linewidth]{"Figure 9b"}
...
\begin{minipage}{0.8\textwidth}
	\centering
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 10a"}
		\caption{Error (boxplot)}
		\label{fig:intel_boxplots}
	\end{subfigure}
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 10b"}
		\caption{Error (time-series)}
		\label{fig:intel_comp}
	\end{subfigure}
...
\begin{minipage}{0.8\textwidth}
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 11a"} 
		\caption{Error (boxplot)}
		\label{fig:irish_boxplots}
	\end{subfigure}
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 11b"} 
		\caption{Error (time-series)}
		\label{fig:irish_comp}
	\end{subfigure}
...
\begin{minipage}{0.8\textwidth}
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 12a"}
		\caption{Error (boxplot)}
		\label{fig:ozone_boxplots}
	\end{subfigure}
	\begin{subfigure}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{"Figure 12b"}
		\caption{Error (time-series)}
		\label{fig:ozone_comp}
	\end{subfigure}
...
\centering
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=\linewidth]{"Figure S3a"}
		\label{fig:linsep_data}
		\caption{Data from classes $A$ and $B$.}
	\end{subfigure}
  	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=\linewidth]{"Figure S3b"}
...
\centering
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=\linewidth]{"Figure S4a"}
		\label{fig:nlinsep_data}
		\caption{Data from classes $A$ and $B$.}
	\end{subfigure}
    	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=\linewidth]{"Figure S4b"}
...
\centering
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{"Figure S5a"}
		\label{fig:fmapped_data}
		\caption{Nonlinear mapping of data.}
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{"Figure S5b"}
...
\begin{figure*}[h]
	\centering
	\begin{subfigure}[t]{0.7\textwidth}
		\includegraphics[width=\linewidth]{"Figure S11a"}
		\caption{Re=100}
		\label{fig:haystack100}
	\end{subfigure}
	\begin{subfigure}[t]{0.7\textwidth}
		\includegraphics[width=\linewidth]{"Figure S11b"}
		\caption{Re=1000}
		\label{fig:haystack1000}
	\end{subfigure}
	\begin{subfigure}[t]{0.6\textwidth}
		\includegraphics[width=\linewidth]{"Figure S11c"}
